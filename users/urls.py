...
from users.views import (UserCreateAPIView, UserDestroyAPIView,
                         ...
                         UserUpdateAPIView, UserRegisterAPIView, PasswordResetAPIView, PasswordResetConfirmAPIView,
...
urlpatterns = [
    ...
    path("email-confirm/<str:token>/", EmailVerificationAPIView.as_view(), name="email_confirm"),
